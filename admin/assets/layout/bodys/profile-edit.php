                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-info" id="editPassBtn" onclick="editPass();">Сохранить изменения</button>
                                </div>                                
                            </div>                              
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Webmoney" id="webmoney__pay">
                                        <label id="webmoney__error" class="error"></label>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                        <input type="group" class="form-control" placeholder="Яндекс деньги" id="yandex__pay">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-info" id="editPaymentBtn" onclick="editPayments();">Сохранить изменения</button>
                                </div>                                
                            </div>                              
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12">
                                    <button class="btn btn-primary" id="editProfileBtn" onclick="editProfileInfo();">Сохранить изменения</button>
                                </div>
                            </div>
                        </div>
                    </div>
