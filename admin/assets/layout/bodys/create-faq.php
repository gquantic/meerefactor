                    ...
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <div class="form-group">                                
                                    <input type="text" name="stateName" id="stateName" placeholder="Название статьи FAQ" class="form-control">
                                </div>

                                <label for="about">Текст</label>
                                <div class="form-group">                                
                                    <div class="summernote" id="descstate"></div>
                                </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $('#savestate').on('click', function(){
        ...
        $.post(
            "/admin/handlers/statecreate.php",
            {
                name: $('#stateName').val(),
