                    ...
                    <div class="d-flex">
                        ...
                        <div class="inbox left" id="email-nav">
                            <!--div class="mail-compose mb-4">
                                <a href="create-offer.php" class="btn btn-danger btn-block">Веб-мастера</a>
                            </div-->
                            <div class="mail-side">
                                <ul class="nav">
                                    <li class="active"><a href="mail-inbox.php"><i class="zmdi zmdi-inbox"></i>Все<span class="badge badge-primary"><?echo $_Db->countEcho("SELECT * FROM `offers` WHERE `author_id`='$userId'");?></span></a></li>

                                    <li><a href="javascript:void(0);"><i class="zmdi zmdi-mail-send"></i>Новые <span class="badge badge-warning"><?echo $_Db->countEcho("SELECT * FROM `offers` WHERE `author_id`='$userId' AND `modercheck`='0'");?></span></a></li>

                                    <li><a href="javascript:void(0);"><i class="zmdi zmdi-badge-check"></i>Одобрены <span class="badge badge-success"><?echo $_Db->countEcho("SELECT * FROM `offers` WHERE `author_id`='$userId' AND `modercheck`='1'");?></span></a></li>

                                    <li><a href="javascript:void(0);"><i class="zmdi zmdi-email"></i>Уведомления</a></li>

                                    <li><a href="javascript:void(0);"><i class="zmdi zmdi-alert-circle"></i>Отклонены <span class="badge badge-danger"><?echo $_Db->countEcho("SELECT * FROM `offers` WHERE `author_id`='$userId' AND `modercheck`='-1'");?></span></a></li>
                            ...
                            <div class="table-responsive">
                                <table class="table c_table inbox_table">
                                    <?
                                            ...
                                            echo '<td class="u_image"><img src="https://yt3.ggpht.com/a/AGF-l79fFaU_DwLYxXUOg22YrahDQ2PMuzz9zeENlg=s900-c-k-c0xffffffff-no-rj-mo" alt="user" class="rounded" width="30"></td>';

                                            echo '<td class="u_name"><h5 class="font-15 mt-0 mb-0">Имя веб-мастера</h6></td>';

                                            echo '<td class="max_ellipsis">
                                                    <a class="link" href="viewOffer?id=4">
                                                        Сообщение от веб-мастера
                                                    </a>
                                                </td>';  

                                            echo '<td class="clip"><i class="zmdi zmdi-attachment-alt"></i></td>';

                                            echo '<td class="time" style="padding-right:15px;">03.07.20</td>';
