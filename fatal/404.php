...
<head>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.1.1/gsap.min.js">
	<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.5.0/gsap.min.js"></script>
	<title>Страница не найдена! | MeeMoney</title>
</head>
<body>
...
<nav data-state="closed">
  <ul>
    <li>
      <a href="https://meemoney.ru/index.html">Главная</a>
    </li>
    <li>
      <a href="https://meemoney.ru/about.html">О проекте</a>
    </li>
    <li>
      <a href="https://meemoney.ru/contact.html">Связаться с нами</a>
    </li>
    <li>
      <a href="/">Кабинет</a>
    </li>
...
<main>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        <h1>404</h1>
        <h2>Страница, которую вы ищите, не найдена.</h2>
        <p>Пожалуйста, убедитесь, что ввели адрес верно или свяжитесь с нами.
        </p>
        <?if($_SESSION['last_url'] != ''){?><a href="<?echo $_SESSION['last_url'];?>"><button class="btn green">НАЗАД</button></a>
        <?}else{?><a href="/"><button class="btn green">ГЛАВНАЯ</button></a><?}?>
        <a href="https://meemoney.ru/contact.html"><button class="btn green">СВЯЗАТЬСЯ</button></a>
      </div>
    </div>
  </div>
</main>
...
body {
  ...
  font-family: "Nunito Sans", "Roboto Condensed";
  color: var(--blue);
  font-size: 1em;
}
